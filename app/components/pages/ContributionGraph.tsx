...
export default function ContributionGraph() {
  ...
  return (
    <div className="flex xl:flex-row flex-col gap-4 flex-grow">
      <div className="dark:bg-primary-bg bg-secondary-bg border dark:border-zinc-800 border-zinc-200 p-8 rounded-lg max-w-fit max-h-fit flex-1">
        <GitHubCalendar
          username={username}
          theme={github}
