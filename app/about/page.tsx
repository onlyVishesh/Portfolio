...
export const metadata: Metadata = {
  title: "About | onlyVishesh",
  metadataBase: new URL("https://onlyvishesh.vercel.app/about"),
  description:
    "Learn more about my skills, experience and technical background",
  openGraph: {
    title: "About | onlyVishesh",
    url: "https://onlyvishesh.vercel.app/about",
    description:
      "Learn more about my skills, experience and technical background",
    images:
          ...
          <div className="order-2 lg:order-none">
            <Slide>
              <h1 className="font-incognito font-semibold tracking-tight sm:text-5xl text-3xl lg:leading-tight basis-1/2 mb-8">
                I&apos;m {profile?.fullName ?? "Vishesh"}. I live in{" "}
              ...
              <div className="sticky top-10">
                ...
                <div className="flex flex-col text-center gap-y-4">
                  <div className="flex items-center gap-x-3">
                    <RefLink
                      href="https://drive.google.com/file/d/1k-CgaL7a0x38PefY6n8uR_DBPTxdq1-u/view?usp=sharing"
